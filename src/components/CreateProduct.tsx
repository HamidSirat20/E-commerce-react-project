...
const CreateProduct = () => {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        e.preventDefault()
        dispatch(createNewProducts({ title, description, price, categoryId, images }))
    }
    return (
        <Box sx={{
            ...
            <form onSubmit={e => handleSubmit(e)}>
                ...
                <Typography variant="body1" gutterBottom>Category ID:</Typography> <br />
                <TextField id="outlined-basic" label="Category ID" variant="outlined" type="number" value={categoryId} onChange={(e) => setCategoryId(Number(e.target.value))} /><br />
                <Typography variant="body1" gutterBottom>Image/s:</Typography> <br />
                <TextField id="outlined-basic" label="Image" variant="outlined" type="text" value={images} onChange={(e) => setImages(e.target.value.split(","))} /><br />
